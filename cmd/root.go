...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.cobra-playground.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".cobra-playground" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".cobra-playground")
	}
